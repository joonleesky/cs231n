...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        #Since stride = 1, pad = (filter_size - 1)//2, spatial size remained after conv
    ...
    def loss(self, X, y=None):
        ...
        scores, s_cache = affine_forward(a2, W3, b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        da2, grads['W3'], grads['b3'] = affine_backward(dscores, s_cache)
